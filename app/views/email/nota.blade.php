...
<head>
    ...
    <title>AMCC</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <table>
            	<tr>
                  ...
                  <div class="text" style="padding: 0 3em 2em; text-align: center;">
                    <p style="color: #000; font-size: 18px; margin-bottom: 10px;">Hi, {{ $data['nama'] }}</p>
            				<h2>Welcome to <span>AMCC family</span>!<br/>Let's <span>build something amazing</span> :)</h2>
            			</div>
            		</td>
            	</tr>
            </table>
